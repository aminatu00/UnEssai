...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-white">Modifier Etudiant</h1>
    ...
    <div class="card">
        <div class="card-body" style="background-color:#081b29;" > 
            <form method="POST" action="{{ route('students.update', $student->id) }}">
                ...
                <button type="submit" class="btn text-white" style="background-image:linear-gradient(180deg, #081b29, #0ef); width:50%; border-radius:40px">Mettre a jour Etudiant</button>
