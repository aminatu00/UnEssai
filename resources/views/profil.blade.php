            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group text-white">
                 ...
                 <div class="form-group text-white">
                    ...
                    <textarea name="description" class="form-control text-white" style="background-color:#081b29;" rows="4">{{ Auth::user()->description }}</textarea>
                </div>
                @endif
                ...
                <!-- Conditions pour afficher les champs pour les étudiants et les tuteurs -->
                @if(Auth::user()->user_type == 'student' || Auth::user()->user_type == 'mentor')
                    ...
                    <div class="form-group text-white">
                       ...
                       <!-- Utilisez une condition ternaire pour garantir que `json_decode` renvoie un tableau même si `Auth::user()->interests` est null -->
@foreach (['informatique', 'reseaux'] as $interest)
    <div class="form-check form-check-inline custom-checkbox text-white">
        <!-- Assurez-vous que `json_decode` renvoie toujours un tableau en utilisant `?? []` -->
